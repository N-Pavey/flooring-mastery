 ...
 */
package com.sgnp.allthemaths.java;
...
public class AllTheMaths {
    ...
    public static void main(String[] args) {
        ...
        // If the decimals are removed and the numbers rounded
        // then the answer given after calculation
        // becomes a whole number as well
        // "8040"
        ...
        /*
            According to the example, the answer for this is 80
            However, when I run it, I'm getting 98.
            The code, as far as I can tell matches though
            and a calculator also yields 98.
            An observation.
        */
