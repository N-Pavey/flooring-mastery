...
public class AddressBookView {
    ...
    public String getAddressChoice() {
        ...
        return io.readString("Please enter the last name of the address you wish to see.");
    ...
    public void displayAddressBookListSize(List<AddressBook> addressListSize) {
        
        io.print("There are " + addressListSize.size() + " addresses in the book.");
        io.readString("\nPlease hit enter to continue.");
